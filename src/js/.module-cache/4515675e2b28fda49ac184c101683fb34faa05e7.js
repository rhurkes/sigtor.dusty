...
dusty.module.iem = (function() {
			...
			return (this.props.message)
				? (React.createElement("li", {className: this.props.message.code}, 
						...
						React.createElement("div", {className: "message"}, 
							React.createElement("span", {dangerouslySetInnerHTML: {__html: this.props.message.html1}}), 
							React.createElement("span", {dangerouslySetInnerHTML: {__html: this.props.message.html2}})
						)
					))
				: null;
		}
	...
	var _formatMessage = function(m) {
		...
		var mbreak = m.message.indexOf('</a>');
		if (mbreak) {
			fm.html1 = m.message.slice(0, mbreak + 4);
			fm.html2 = m.message.slice(mbreak + 4)
		}
